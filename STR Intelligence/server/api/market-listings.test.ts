...
test("returns the saved safe collection", async () => {
  const collection = { label: "Pilot", gateway: "arch_rock" as const, status: "complete" as const, page: 1, collectedPages: [1], providerTotalCount: 149, savedCount: 1, collectedAt: "2026-09-06T12:00:00Z", listings: [] };
